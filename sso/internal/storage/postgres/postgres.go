...
func (s *Storage) SaveUser(ctx context.Context, email string, passwordHash []byte, name string, phone string, address string) (int64, error) {
	const op = "storage.postgres.SaveUser"
	
	query := `INSERT INTO users(email, password_hash, name, phone, address) VALUES ($1, $2, $3, $4, $5) RETURNING id`
